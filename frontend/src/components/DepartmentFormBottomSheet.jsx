...
import { DepartmentForm } from '@/pages/Department/DepartmentList'

/**
 * Bottom sheet (mobile) com o formulário de criação/edição de departamento.
 */
const DepartmentFormBottomSheet = ({ isOpen, onClose, department, onSave }) => {
    useEffect(() => {
        if (!isOpen) return
...
export default DepartmentFormBottomSheet
