...
const variantStyles = {
  ...
  error: {
    container: 'border-[var(--color-danger-border)] bg-[var(--color-danger-soft)]',
    icon: XCircle,
    iconClass: 'text-[var(--color-danger)]',
    text: 'text-[var(--color-danger-strong)]',
    close: 'text-[var(--color-danger-strong)] hover:bg-[var(--color-surface-muted)]',
  },
  warning: {
    ...
    close: 'text-[var(--color-warning-text)] hover:bg-[var(--color-surface-muted)]',
  },
  info: {
    container: 'border-[var(--color-border-default)] bg-[var(--color-accent-soft)]',
    icon: Info,
